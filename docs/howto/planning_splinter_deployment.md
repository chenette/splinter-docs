...
![Splinter deployment overview](../images/splinter-deployment-overview.png "Splinter deployment overview")
...
* **8085**: Application communication (encrypted with SSL) via the splinterd
  REST API
...
Communication over this connection is encrypted with SSL.
...
sends all HTTP requests to the SSL port.

![Splinter network configuration](../images/splinter-deployment-network-config.png "Splinter network configuration")
...
![Splinter application pattern](../images/splinter-deployment-application-pattern.png "Splinter application pattern")
...
![Splinter Docker deployment](../images/splinter-deployment-docker.png "Splinter Docker deployment")
...
![Splinter Kubernetes deployment](../images/splinter-deployment-kubernetes.png "Splinter Kubernetes deployment")
...
![Splinter Amazon EKS deployment](../images/splinter-deployment-amazonEKS.png "Splinter Amazon EKS deployment")
